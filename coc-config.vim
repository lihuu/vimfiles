...
"coc.nvim configuration
"coc-tabnine
let g:coc_global_extensions=['coc-sh','coc-json','coc-css','coc-tsserver','coc-html','coc-marketplace','coc-git','coc-lua','coc-pyright','coc-xml','coc-yaml','coc-go','coc-clangd','coc-prettier','coc-styled-components','coc-snippets','coc-svg','coc-perl','coc-vimlsp']
