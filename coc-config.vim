...
"coc.nvim configuration
"coc-tabnine
let g:coc_global_extensions=['coc-sh','coc-json','coc-css','coc-tsserver','coc-html','coc-marketplace','coc-git','coc-lua','coc-pyright','coc-xml','coc-yaml','coc-go','coc-clangd','coc-prettier','coc-tabnine','coc-styled-components','coc-powershell','coc-snippets','coc-svg']
